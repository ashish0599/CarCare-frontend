    ...
    return(
        ...
        <nav className="navbar navbar-expand-lg navbar-dark navs">
            ...
            <div style={{width:"100px" , height:"60px" , marginRight:"25px" , marginLeft:"15px"}}>
                <img src="./images/9989.jpg" alt="brandLogo" style={{width:"100%" , height:"100%"}}/>
            </div>
            ...
            <div className="collapse navbar-collapse" id="navbarTogglerDemo02" style={{justifyContent: "space-between"}}>
                ...
                <li className="nav-item active" style={{marginRight:"20px" }}>
                    <NavLink  exact className="nav-link" to="/" activeStyle={t1 ? {color:"blue"} : {color:"black"}} 
                    onClick={()=>{
                        setT1(true)
                        setT2(false)
                        setT3(false)
                ...
                <li className="nav-item" style={{marginRight:"20px" }}>
                    <a className="nav-link try"  disabled href="#paisa"  style={t2===true ? {color:"blue"}:{color:"black"}}
                    onClick={()=>{
                        setT2(true)
                        setT3(false)
                        setT1(false)
                ...
                <li className="nav-item" style={{marginRight:"20px" }}>
                    <a className="nav-link try" href="#aboutUs_contactUs" style={t3 ? {color:"blue"} : {color:"black"}}
                     onClick={()=>{
                        setT1(false)
                        setT2(false)
                        setT3(true)
                ...
                <li className="nav-item" style={{marginRight:"20px" }}>
                    <a className="nav-link try" href="#aboutUs_contactUs" style={t4 ? {color:"blue"} : {color:"black"}}
                     onClick={()=>{
                        setT1(false)
                        setT2(false)
                        setT3(false)
                ...
                <li className="nav-item active" style={{marginRight:"20px" }}>
                    <NavLink  exact className="nav-link" to="/booked_Appointments" activeStyle={t5 ? {color:"blue"} : {color:"black"}} 
                    onClick={()=>{
                        setT5(true)
                        setT1(false)
                        setT2(false)
                    ...
                    }}>Appointments <span className="sr-only">(current)</span></NavLink>
                </li>
                </ul>
                <ul className="navbar-nav ">
                <li className="nav-item" style={{marginRight:"100px" }}>
                {
                    ...
                    <div className="dropdown">
                        ...
                        <Link to="/" style={{textDecoration:"none"}}>
                         ...
                         <button className="dropdown-item drop" type="button" style={{cursor:"pointer"}}>Appointments</button>
                         </Link>
                    </div>
                    </div> :
                     <button 
                     style={{cursor:"pointer" , border:"1px solid black" , padding:"5px 20px" ,borderRadius:"0.7rem"}} 
                     onClick={()=>{
                         history.push("/login")
